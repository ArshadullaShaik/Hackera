...
export class DoraHacksScraper {
    constructor() {
        this.baseUrl = "https://dorahacks.io/hackathon";
        ...
        this.detailConcurrency = 1;
    }
    async fetchSlugsWithPlaywright() {
    ...
    normalize(raw) {
        ...
        let prizePool = "Prizes Available";
        ...
        const formattedDescription = formatDescription(String(raw.description || ""), tracks, prizePool);
...
//# sourceMappingURL=dorahacks.scraper.js.map